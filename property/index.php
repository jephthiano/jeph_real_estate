...
$page = "PROPERTY CATEGORIES | ".strtoupper(get_xml_data('company_name'));
$page_name = $page." | ".get_xml_data('seo_tag');
$page_url = file_location('home_url','property/');
...
<body id="body" class="j-color4" style="font-family:Roboto,sans-serif;">
	<?php
	$property_data = ['page_load','navigation','property/property_category','footer','js'];
