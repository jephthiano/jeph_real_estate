<div class='j-home-padding'>
 <div style="margin-bottom:40px;margin-top:10px;">
  <div class="j-bolder j-xxlarge j-padding"style="border-left:solid 10px red;margin-bottom:3px;">Blogs</div>
  ...
  <div>
   ...
   if($or !== false){
    ...
    ?><div class='j-center j-large'>No blog available at the moment</div><?php
   }
   ?>
  </div>
 </div>
