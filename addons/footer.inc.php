<section id="footer"title='<?=ucwords(get_xml_data('company_name'))?> Footer'class="j-color3 j-text-color4 j-home-padding"style="padding-bottom:8px;padding-top:8px">
	...
	<div class=''>
		<div class='j-row j-text-color4'>
			...
			<div class='j-col m3 j-padding'>
				...
				<div class='j-text-color6'>
					<?php
					$or = multiple_content_data('partner_table','p_id','','',"ORDER BY p_id LIMIT 4");
					if($or !== false){
					...
					?>
					<a href="<?=file_location('home_url','misc/partners/')?>" class='j-underline'>See all partners</a>
				</div>
			</div>
		</div>
	</div>
