...
function file_location($type='home_url',$filename = ''){
 ...
 if(strstr($local_url,'000webhostapp') || $link_type === 'internal_link'){
  ...
  //for url
  $home_url = "https://www.jephrealestate.com/";
  $admin_url = "https://admin.jephrealestate.com/";
 }
...
$fur = ['json','xml','general','server_and_page','file_upload','date_and_time','device_and_location','get_database','money','modal','social_handle','partner','team','testimonial','news','comment','property'];
